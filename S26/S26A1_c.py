...
entrada_valor = tk.Entry(janela, bg="#2e2e2e", fg="#ffffff", insertbackground="#ffffff")
entrada_valor.pack()

# Botão de gerar
tk.Button(janela, text="Gerar Vetor", command=exibir_resultado, bg="#3a3a3a", fg="#ffffff").pack(pady=10)

# Área de resultado
resultado_label = tk.Label(janela, text="", justify="left", wraplength=300, **estilo_escuro)
resultado_label.pack(pady=10)

# Botão de exportar
botao_exportar = tk.Button(janela, text="Exportar para .txt", command=exportar_para_txt, bg="#3a3a3a", fg="#ffffff")
