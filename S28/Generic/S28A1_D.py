...
class Jogo2048:
    ...
    def tratar_tecla(self, evento):
        ...
        if tecla in direcoes:
            ...
            if self.verificar_vitoria():
                self.instrucoes["text"] = " Parabéns! Você venceu com 2048!"
            elif not self.movimentos_possiveis():
    ...
    def modo_demo(self):
        def jogar():
            if self.verificar_vitoria():
                self.instrucoes["text"] = " Modo Demo venceu com 2048!"
                return
            elif not self.movimentos_possiveis():
                self.instrucoes["text"] = " Modo Demo terminou sem vitória."
                return
            ...
            # Se nenhuma jogada foi possível, encerrar
            self.instrucoes["text"] = " Modo Demo não conseguiu iniciar."
        jogar()
    ...
    def mostrar_regras(self, evento=None):
        ...
        texto = (
            ...
            "- Contador de jogadas mostra seu progresso.\n"
        )
